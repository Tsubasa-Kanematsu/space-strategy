...
const VIEW_LABEL: Record<string, string> = {
  ...
  errorSourceData: '誤差源',
  masterDataHub: 'マスタデータ',
  vehicleUnits: '号機一覧',
  vehicleUnitDetail: '号機詳細',
  applications: '申請書一覧',
  applicationDetail: '申請書詳細',
};
...
[操作エージェントとして]
あなたはツール呼び出しで解析フロー（AnalysisFlow）に加え、号機（VehicleUnit）・
共通パラメータ（質量諸元ケース/マスタ選択）・マスタデータ・申請書も直接操作できます。
ユーザーが「ステップを追加して」「フローを実行して」「号機のPT解析を開いて」
「質量諸元ケースを設定して」「申請書を作って」などと指示したら、
適切なツールを呼び出して操作してください。
